...
```bash
pipx install --force "plugin-scanner==3.0.107"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `651a5e981bc562a8c3191497a03f4ed85aae3bc982d61fa1ddebf9883b73c65c`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.107"
