...
```bash
pipx install --force "plugin-scanner==3.0.100"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `23031667b9faab098cb139fc25f1a98cc68357df530f5272e3866607a44599dc`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.100"
