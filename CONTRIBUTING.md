...
```bash
pipx install --force "plugin-scanner==3.0.106"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `cff41781c26cb980411154eddbfd41d69f452033fb9c7304db7e44b73f063557`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.106"
