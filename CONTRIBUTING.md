...
```bash
pipx install --force "plugin-scanner==3.0.109"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `b6deda0498c394db5041938b0959efaab3dff6489895eac10ab11e3f54da0275`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.109"
